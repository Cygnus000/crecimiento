program logistico
    ...
    real(kind=real64), parameter :: x0 = 0.05d0
    real(kind=real64), parameter :: k = 0.1d0
    real(kind=real64), parameter :: x_max = 120.0d0
...
!**********************************************************************
    ...
    close(1) 
    call system('gnuplot -c logistico.p')
!**********************************************************************
contains
!**********************************************************************
