program explin
    ...
    real(kind=real64), parameter :: x0 = 2.0912d0
    real(kind=real64), parameter :: k00 = 0.31d0
    real(kind=real64), parameter :: k01 = 67.8d0
    real(kind=real64), parameter :: tau = 15.0d0
...
!**********************************************************************
    ...
    close(1) 
    call system('gnuplot -c explin.p')
!**********************************************************************
contains
!**********************************************************************
